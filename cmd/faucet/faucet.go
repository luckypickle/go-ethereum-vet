...
import (
	...
	"github.com/luckypickle/go-ethereum-vet/ethclient"
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/luckypickle/go-ethereum-vet/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
